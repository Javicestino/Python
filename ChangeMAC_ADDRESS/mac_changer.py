...
def get_arguments():
    ...
    if not options.interface:
        parser.error("[-] Porfavor introduzca una interdaz valida, para más información introduzca --help")
    elif not options.new_mac:
        parser.error("[-] Por favor indicar una dirección MAC valida, para más información introduzca --help")
